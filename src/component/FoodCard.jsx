...
const FoodCard = ({number,setNumber}) => {
 ...
 let [totalAmt,setTotalAmt] = useState(price+delivery_fee+platform_fee+gst) 
  ...
  return (
    ...
    <div className='food-item-card'>
      ...
      <i class='bx bx-minus' onClick={()=>{
        if (number == 0) {
          alert("you can not remove item anymore")
        }
        if (!number==0) {
          setNumber(number-1)
